...
## Instalar benchmark  e testar (ApacheBench):
  ...
  ```
      *Retorna informação similar a:*
      ...
      Benchmarking 35.247.223.96.nip.io (be patient)
      Completed 5000 requests
      Completed 10000 requests
      Completed 15000 requests
      Finished 16605 requests


      Server Software:
      Server Hostname:        35.247.223.96.nip.io
      Server Port:            80
      ...
      Complete requests:      16605
      Failed requests:        0
      Keep-Alive requests:    16605
      Total transferred:      3404025 bytes
      HTML transferred:       1062720 bytes
      Requests per second:    830.17 [#/sec] (mean)
      Time per request:       120.457 [ms] (mean)
      Time per request:       1.205 [ms] (mean, across all concurrent requests)
      Transfer rate:          166.20 [Kbytes/sec] received

      Connection Times (ms)
                    min  mean[+/-sd] median   max
      Connect:        0    1   9.1      0     121
      Processing:   117  118   2.2    117     147
      Waiting:      117  118   2.2    117     147
      Total:        117  119  10.6    117     266
